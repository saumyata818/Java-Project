...
public class ShowSpecUserRents implements Operation {
    public void operation(final Database database, final JFrame f, final User user) {
        final JFrame frame = new JFrame("Show User's Rents");
        frame.setSize(600, 260);
        frame.setLocationRelativeTo(f);
        frame.getContentPane().setBackground(new Color(227, 191, 46));
